...
public class message extends javax.swing.JFrame {
    ...
    private void setting() {
        try {
            ...
            Font fotn = new Font("Vazirmatn-SemiBold.ttf", Font.BOLD, 22);
            jLabel4.setFont(fotn);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 120, 110, 49));

        jLabel4.setText("شما در نام کاربری کاریکترها را استفاده کرده نمیتوانید فقط حروف");
